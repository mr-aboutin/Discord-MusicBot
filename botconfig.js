module.exports = {
  ...
  DefaultVolume: 2, //Sets the default volume of the bot, You can change this number anywhere from 1 to 100
  ...
  Presence: {
    ...
    name: "Something!", // The message shown
  ...
  Lavalink: {
    ...
    host: "lavalink.jayden.sh", //- The host name or IP of the lavalink server.
